...
import smartcrud.common.orm.PageConstants;
...
public class ServletUtils {
	...
	public static Map getParametersStartingWith(ServletRequest request) {
		return getParametersStartingWith(request, PageConstants.FILTER_PREFIX);
	}
	...
	public static String encodeParameterStringWithPrefix(
		...
		return encodeParameterStringWithPrefix(request,
				PageConstants.FILTER_PREFIX);
	}
