...
public class Many2OneController {
	...
	public void create(Employee employee,Model model) {
		//Encountered unmanaged object "org.ccs.cyperweb.model.EmployeeType@3a1e8730" in life cycle state
		//unmanaged while cascading persistence via field "org.ccs.cyperweb.model.Employee.employeeType" during flush.  
		//However, this field does not allow cascade persist. 
		//You cannot flush unmanaged objects or graphs that have persistent associations to unmanaged objects.
