...
you can fork this project <a href="http://git.oschina.net/uniquejava/cyperweb"><code>here</code></a>.
</p>
...
<li>Spring Cloud</li>
<li>Maven</li>
<li>Websphere Liberty Profile 8.5.5</li>
<li>MySQL</li>
</ol>
...
<h5>b. Use Maven -&gt; Updae Project..(Alt +F5) <code>with caution!</code> Below error can be occurred：</h5>
...
<h3>Auto binding configurations</h3>
...
<p>BTW, <code>service-name</code> is optional if there is only one RDBMS service bind to this app.

</p>
<h3>Odds and ends</h3>
<ol>
<li>You need to bind mysql service before you start application the first time.</li>
